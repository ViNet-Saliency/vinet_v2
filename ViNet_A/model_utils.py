...
class MLP(nn.Module):
	def __init__(self,input_channels,out_channels=None):
		...
		self.conv1 = nn.Sequential(nn.Conv3d(input_channels, input_channels // 2, kernel_size=(1,1,1), stride=(1,1,1), padding=(0,0,0)),
									nn.ReLU(),
									nn.Conv3d(input_channels// 2, out_channels, kernel_size=(1,1,1), stride=(1,1,1), padding=(0,0,0))
									)
