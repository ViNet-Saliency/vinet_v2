...
#     --len_snippet 64 \
#     --decoder_groups 32 \
#     --model_tag 'neck_1gpus_sid_extra_data_reloaded_best_0.5s_baseline_dhf1k_init_64clipsize_corrected_run1' \
#     --no_epochs 150 \
#     --subset_type 'all' \
...
python train.py --dataset $dataset \
    ...
    --len_snippet 32 \
    --decoder_groups 32 \
    --model_tag 'neck_1gpus_sid_extra_data_reloaded_best_0.5s_baseline_dhf1k_init_64clipsize_corrected_rndseed_run1' \
    --no_epochs 150 \
    --subset_type 'all' \
    --use_image_saliency 0 \
    --reload_data_every_epoch 1 \
...
#     --len_snippet 32 \
#     --decoder_groups 16 \
#     --model_tag 'neck_bifpn_1gpus_sid' \
#     --no_epochs 100 
