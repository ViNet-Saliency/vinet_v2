...
import sys
# sys.path.insert(0,'/home/girmaji08/ACARSaliency/SaliencyModel')
# import config as global_config
import argparse
import pdb
# from predict import config as global_config
BN = nn.BatchNorm3d
...
class SlowFast(nn.Module):
	def __init__(self, block, layers, alpha=4, beta=0.125, fuse_only_conv=True, fuse_kernel_size=5, slow_full_span=False,use_skip=False):
		super(SlowFast, self).__init__()
		#changed alpha & beta from 8 & 1/8 to 4 & 1/4 respectively
		self.alpha = alpha
		self.beta = beta
