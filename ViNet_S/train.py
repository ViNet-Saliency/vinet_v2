...
parser.add_argument('--train_path_data',default="/ssd_scratch/cvit/sarthak395/DHF1K/annotation", type=str)
parser.add_argument('--val_path_data',default="/ssd_scratch/cvit/sarthak395/DHF1K/val", type=str)
...
if args.combine_datasets:
    ...
    if args.dataset == "DHF1KDataset":
        ...
        train_dataset = SoundDatasetLoader(args.clip_size, mode="train", dataset_name=args.dataset, split=args.split ,use_sound=args.use_sound, use_vox=args.use_vox)
        val_dataset = SoundDatasetLoader(args.clip_size, mode="val", dataset_name=args.dataset, split=args.split, use_sound=args.use_sound, use_vox=args.use_vox)
