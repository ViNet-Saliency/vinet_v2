...
python3 train.py --train_path_data /home/sid/UCF/training \
...
--root_grouping True \
--grouped_conv True \
--load_weight /home/sid/SaliencyModel/testSal/vinet_rootgrouped_32.pt \
--model_val_path vinet_rootgrouped_32_ucf_fine-tune_bs8.pt \
--no_epochs 100
